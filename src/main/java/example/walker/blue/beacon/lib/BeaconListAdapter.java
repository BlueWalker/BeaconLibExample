...
public class BeaconListAdapter extends ArrayAdapter<Beacon> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.uuidText.setText(String.format(UUID_TEXT_FORMAT, beacon.getUUID()));
        holder.icon.setImageResource(R.drawable.ic_launcher_blue);
        return rowView;
    }

    @Override
    public Beacon getItem(final int position) {
